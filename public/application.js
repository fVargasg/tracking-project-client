...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://secret-meadow-81980.herokuapp.com',
...
var showModalMessage = function showModalMessage(type, error) {
...
var projectEvents = __webpack_require__(11);
...
var onSignOut = function onSignOut(event) {
  ...
  api.signOut(data).then(function () {
...
/* show password modal */
var showPasswordForm = function showPasswordForm() {
...
var showDashBoard = function showDashBoard() {
  $('#show-dashboard').addClass('active');
  $('#show-user-profile').removeClass('active');
  $('#div-main').fadeIn();
...
var showUserProfile = function showUserProfile() {
  ...
  api.showUserProfile().then(function (result) {
...
var updateUserProfile = function updateUserProfile(event) {
  event.preventDefault();
  ...
  api.updateUser(data).then(function (result) {
    console.log(result);
    ui.hideProgress();ui.showModalMessage('success');
    $('#user-photo-profile').attr('src', result.user.photo);
...
var showUserProjects = function showUserProjects() {

  ui.showProgress();

  api.getUserProjects().then(function (data) {
...
/* Projects */
var createNewProject = function createNewProject(event) {
  event.preventDefault();
  ...
  api.createProject(data).then(function (result) {
...
var updateProject = function updateProject(event) {
  event.preventDefault();
  ...
  api.updateProject(data).then(function (result) {
    cancelEditProject();
    showUserProjects();
...
var deleteProject = function deleteProject() {
  ...
  ui.showProgress();
  api.deleteProject(_project_id).then(function (result) {
    showUserProjects();
    ui.showModalMessage('success');
  }).catch(function (error) {
    ui.hideProgress();ui.showModalMessage('error', error);
...
/* stories */
var createNewStory = function createNewStory(event) {
  event.preventDefault();
  ...
  api.createStory(data).then(function (result) {
...
var showProjectStories = function showProjectStories() {

  ui.showProgress();

  api.getProjectStories(_project_id).then(function (result) {
    ...
    if (result.stories.length > 0) {
      ...
      $.each(result.stories, function (index, element) {
...
/* tasks */
var createNewTask = function createNewTask(event) {
  event.preventDefault();
  ...
  api.createTask(data).then(function (result) {
    clearFields();ui.hideProgress();ui.showModalMessage('success');
  }).catch(function (error) {
    ui.hideProgress();ui.showModalMessage('error', error);
  });
};
var showStoryTasks = function showStoryTasks(storyid) {

  ui.showProgress();

  api.getStoryTasks(storyid).then(function (result) {
...
// Misc
var showViewEditProfile = function showViewEditProfile() {
  $('#card-user').hide();$('#view-edit-profile').fadeIn();$('#txt-name').focus();
};
var showViewChangePassword = function showViewChangePassword() {
  $('#card-user').hide();$('#view-change-password').fadeIn();$('#txt-old-password').focus();
};
var cancelChangePassword = function cancelChangePassword() {
  $('#view-change-password,#view-edit-profile').hide();$('#card-user').fadeIn();
};
var showViewEditProject = function showViewEditProject() {
  $('#div-details-project').hide();$('#div-update-project').fadeIn();
};
var cancelEditProject = function cancelEditProject() {
...
var showModalProject = function showModalProject() {
  ...
  setTimeout(function () {
    $('#txt-name-project').focus();
  }, 800);
};
/* create story modal */
var showModalCreateStory = function showModalCreateStory() {
 ...
 *
 */
var getUserProjects = function getUserProjects() {
 ...
 * Return a promise.
 */
var deleteProject = function deleteProject(project_id) {
 ...
 * Return a promise.
 */
var getProjectStories = function getProjectStories(projectId) {
 ...
 * Return a promise.
 */
var getStoryTasks = function getStoryTasks(story_Id) {
...
module.exports = __webpack_require__.p + "3c6467278a66af3216348e8588a69062.png";

/***/ }),
/* 22 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "c2149cee2ff645e867815b276d61f876.png";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "0455b90df52bf4ddfeb6d946c5ea3701.png";

/***/ }),
/* 24 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6be21e8a1b7d63048728851c6003e189.jpg";
